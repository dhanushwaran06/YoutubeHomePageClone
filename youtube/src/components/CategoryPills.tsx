  ...
  return (
    <div ref={containerRef} className="overflow-hidden relative">
      <div
        ...
        gap-3 transition-transform w-[max-content]"
      ...
      {isLeftVisiable && (
       ...
       bg-gradient-to-r from-white from-50% to to-transparent w-24 
       h-full
      "
        >
          <Buttons
      ...
      {isRightVisiable && (
       ...
       bg-gradient-to-l from-white from-50% to to-transparent w-24 
